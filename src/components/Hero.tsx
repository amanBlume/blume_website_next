      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Social proof badge */}
            <div className="inline-flex items-center gap-2 bg-white border border-coral-100 rounded-full px-4 py-2 shadow-sm mb-6">
              <span className="text-coral-500 font-bold text-sm">40+</span>
              <span className="text-gray-600 text-sm">medical directories. One platform.</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-6">
              <Link
                href="/schduleDemo"
                className="px-8 py-4 bg-coral-500 text-white rounded-full hover:bg-coral-600 transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl transform hover:-translate-y-1 text-lg text-center"
              >
                Book a Free Demo
              </Link>
              <Link
                href="/pricing"
                className="px-8 py-4 text-coral-600 border-2 border-coral-600 rounded-full hover:bg-coral-50 transition-all duration-300 font-semibold text-lg text-center"
              >
                See Pricing
              </Link>
            </div>
            ...
            <p className="text-sm text-gray-400">
              No credit card required &nbsp;·&nbsp; Free 1-on-1 demo &nbsp;·&nbsp; Cancel anytime
            </p>
          </div>
